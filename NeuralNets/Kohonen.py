...
#InputArray = [[0.855, 0.146, 0.586, 0.174],
#                  [0.977, 0.576, 0.587, 0.774],
#                  [0.799, 0.169, 0.434, 0.163],
#                  [0.704, 0.062, 0.910, 0.734],
#                  [0.979, 0.672, 0.456, 0.604]]
   
    
#    W = [[0.855, 0.619, 0.520, 0.723], # claster 1    
#         [0.866, 0.07, 0.896, 0.650], # claster 2
#         [0.733, 0.153, 0.491, 0.201]]